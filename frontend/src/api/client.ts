...
export const api = {
  ...
  initUpload: (file: File, contentRange?: string) => json<UploadInit>("/api/uploads/init", { method: "POST", body: JSON.stringify({ fileName: file.name, contentType: file.type, sizeBytes: file.size, ...(contentRange ? { contentRange } : {}) }) }),
