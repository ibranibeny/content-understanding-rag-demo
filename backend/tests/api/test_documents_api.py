...
def record(
    ...
    *,
    ...
    return DocumentRecord(
        ...
        size_bytes=100,
        blob_name=f"uploads/{session}/{document_id}/private-invoice.pdf",
        state=state,
        ...
        content_result_id="remote-result-secret",
        content_operation_url="https://internal.example/operations/secret",
        extraction={"vendorName": "Contoso", "total": 42},
        markdown_blob_name=f"derived/{session}/{document_id}/content.md",
        page_count=2,
        chunk_count=3,
        token_count=50,
        failure_code="transient_failure" if state is DocumentState.FAILED else None,
